# Version 1.7 Release Checklist

## Pre-release Steps
- [x] Update app/build.gradle.kts with versionCode = 8 and versionName = "1.7"
- [x] Update update.json with new version information and download URL
- [x] Update AppUpdateManager.kt URL to point to the main branch (if changed)
- [x] Review and test new features and bug fixes for version 1.7
- [x] Update release notes in update.json with all new changes
...
- [ ] Set the tag to "v1.7"
- [ ] Set the release title to "Version 1.7"
- [ ] Add release notes with all new features and improvements
- [ ] Upload the APK file to the release
- [ ] Publish the release

## Update Testing
- [ ] Install version 1.6 on a test device (if not already installed)
- [ ] Launch the app and verify it detects the version 1.7 update
...
## Notes
Remember: The auto-update system will handle all these steps automatically for your users. Once a user with version 1.6 opens the app, they will be prompted to update to version 1.7.
